		...
		function MenuItem({ label, title, onClick, glyph, danger }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
				...
				style: {
					...
					borderRadius: 8,
					background: "transparent",
					color: danger ? "var(--dsw-alias-state-error-primary, #ff8592)" : "var(--dsw-alias-label-primary, #f2f6fc)",
					font: "inherit",
					fontSize: 14,
					lineHeight: "22px",
					cursor: "pointer",
				...
				onMouseEnter: (e) => {
					e.currentTarget.style.background = "var(--dsw-alias-interactive-bg-hover-danger, rgba(236,19,19,0.12))";
				},
				onMouseLeave: (e) => {
